...
| 이름 | 학과 | 역할 |
|------|------|------|
| 김유진 | AISW학과 | 팀장 · UI/UX 디자인 · 기획 |
| 조성은 | AISW학과 | 웹 개발 · AI Agent 설계 |
| 김민채 | AISW학과 | 영상 편집 · 문서 작성 |
...
| 메뉴 이미지 · 캐릭터 이미지 | Claude(Anthropic)로 생성한 AI 이미지 — 팀 자체 제작, 외부 저작물 미사용 |

> 본 프로젝트는 2026 AI・SW중심대학 디지털 경진대회 SW 부문 예선 산출물이며, 사용된 모든 외부 자원의 라이선스 및 사용 조건을 준수합니다.

## License

본 저장소는 **2026 AI・SW중심대학 디지털 경진대회 SW 부문 제출용 산출물**입니다.
심사 및 학습·참고 목적의 열람은 자유롭게 하실 수 있으나, 팀 아날로그의 사전 동의 없는 상업적 이용·재배포·2차 저작물 제작은 허용하지 않습니다.

© 2026 팀 아날로그 (한신대학교). All rights reserved.
